**English:** `typedef __int128 int128_t;`
`void store_prod(int128_t *dest, int64_t x, int64_t y) {`
`    *dest = x * (int128_t) y;`
`}`
From the hint:
The 128 bits of x can be rewritten as xh * 2^64 + xl.
The 128 bits of y can be rewritten as yh * 2^64 + yl.
Then x * y = 2^128 * xh * yh + 2^64(xh * yl + xl * yh) + xl * yl.
The term 2^128 * xh * yh overflows beyond 128 bits, so it is discarded.
What remains is to compute 2^64(xh * yl + xl * yh) + xl * yl.

**简体中文：** typedef __int128 int128_t;<br>
