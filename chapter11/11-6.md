**English:** A. Replace the `doit` function with the following:
...
```
**English:** The browser then displays that the returned response is invalid.<br/>
<br/>

**简体中文：** 结果浏览器会显示返回的响应无效<br/>
<br/>
